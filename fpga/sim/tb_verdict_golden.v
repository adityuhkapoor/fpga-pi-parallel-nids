...
module tb_verdict_golden;
    ...
    initial begin
        hdr[1]  = 160'hc0000201c0000202303900500602003c00000000;  // clean TCP
        gold[1] = 160'ha500000001000000000000000000000000000000;
        hdr[2]  = 160'hc0000201c6336401303901bb0602003c00000000;  // dst C2
        gold[2] = 160'ha501030102000000000000000000000000000000;
        hdr[3]  = 160'hcb007105c0000201303900500602003c00000000;  // src C2
        gold[3] = 160'ha501030103000000000000000000000000000000;
        hdr[4]  = 160'hc0000232c0000263303900351100003c00000000;  // dst C2, UDP
        gold[4] = 160'ha501030104000000000000000000000000000000;
        hdr[5]  = 160'h0a0000010a000002303900351100003c00000000;  // clean UDP
        gold[5] = 160'ha500000005000000000000000000000000000000;
        hdr[6]  = 160'hc6336401cb007105303900500602003c00000000;  // both C2
        gold[6] = 160'ha501030106000000000000000000000000000000;
