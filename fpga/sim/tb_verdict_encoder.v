...
module tb_verdict_encoder;
    ...
    initial begin
        ...
        drive_check(1, 4'b0000, 2'd0, 1'b0, 8'd1,   256'ha500000001000000000000000000000000000000000000000000000000000000);
        drive_check(2, 4'b0001, 2'd3, 1'b1, 8'd2,   256'ha501030102000000000000000000000000000000000000000000000000000000);
        drive_check(3, 4'b0010, 2'd2, 1'b0, 8'd3,   256'ha502020003000000000000000000000000000000000000000000000000000000);
        drive_check(4, 4'b0100, 2'd1, 1'b0, 8'd4,   256'ha504010004000000000000000000000000000000000000000000000000000000);
        drive_check(5, 4'b0111, 2'd3, 1'b1, 8'd5,   256'ha507030105000000000000000000000000000000000000000000000000000000);
        drive_check(6, 4'b0000, 2'd0, 1'b0, 8'd255, 256'ha5000000ff000000000000000000000000000000000000000000000000000000);
        drive_check(7, 4'b0001, 2'd3, 1'b1, 8'd0,   256'ha501030100000000000000000000000000000000000000000000000000000000);
