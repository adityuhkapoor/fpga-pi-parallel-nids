`timescale 1ns/1ps
// Packs a classification result into the 32-byte v2 verdict frame (PROTOCOL.md Response).
// Byte 0 magic, 1 stage-hit mask, 2 severity, 3 flags, 4 seq, 5-31 reserved.
...
module verdict_encoder #(
    ...
    input  wire [3:0]               hit_mask,   // bit0 bloom, bit1 port-scan, bit2 rate, bit3 rule (v2 step 4)
    ...
    localparam RSVD = (FRAME_BYTES-5)*8;   // reserved bytes 5..31
    ...
    always @(posedge clk) begin
        ...
        if (rst) begin
            ...
            verdict_frame <= {8'hA5, {4'b0, hit_mask}, {6'b0, severity},
